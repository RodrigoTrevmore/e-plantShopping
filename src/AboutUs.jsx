  ...
  return (
    <div className="about-us-container">
      ...
      <p className="about-us-content">
        At Marilena Nursery, we are passionate about bringing Brazilian nature closer to you. Our mission is to provide a wide range of 
      ...
      <p className="about-us-content">
        Join us in our mission to create a greener, healthier world. Visit Marilena Nursery today and experience the 
